...
public class Message {
	...
	public long socketId = 0; // the id of source socket or destination socket,
								// depending on whether is going in or out.

	public byte[] sharedArray = null;
	public int offset = 0; // offset into sharedArray where this message data
							// starts.
	public int capacity = 0; // the size of the section in the sharedArray
	...
	/**
	 * Writes data from the ByteBuffer into this message - meaning into the
	 * buffer backing this message.
	 *
	 * @param byteBuffer
	...
	/**
	 * Writes data from the byte array into this message - meaning into the
	 * buffer backing this message.
	 *
	 * @param byteArray
	 ...
	 *
	 * @param message
	 *            The message containing the partial message (after the first
	 *            message).
	 * @param endIndex
	 *            The end index of the first message in the buffer of the
